          ...
          <DialogContent className="max-w-md bg-white p-6">
            ...
            <form onSubmit={handleCreateUser} className="mt-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-bold uppercase text-charcoal">No. Registrasi Pendaftaran</label>
                  {role === "PESERTA" ? (
                    <input
                      type="text"
                      value={participantNumber}
                      onChange={(e) => setParticipantNumber(e.target.value)}
                      placeholder="REG-AK-XXXXXX (Kosongkan utk Auto-Generate)"
                    ...
                    <input
                      ...
                      disabled
                      value="-"
                      title="Akun Admin tidak memerlukan Nomor Registrasi Pendaftaran"
          ...
          <DialogContent className="max-w-md bg-white p-6">
            ...
            <div className="mt-4 space-y-3 text-xs">
              ...
              <div className="space-y-2 border-t border-border/40 pt-3">
                ...
                <div className="flex justify-between py-1 border-b border-border/20">
                  <span className="font-bold text-muted-foreground">No. Registrasi Pendaftaran:</span>
                  <span className="font-mono font-bold text-forest-900">
                    {verifyTarget.participant_number || "REG-AK-XXXXXX (Auto-Generated)"}
                  </span>
                </div>
