...
function ParticipantLayout() {
  ...
  if (loading) {
    return (
      <div className="flex h-screen items-center justify-center bg-ivory">
        <div className="text-sm font-semibold text-forest-900">Memuat Sesi Peserta...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-ivory text-charcoal">
      ...
      {/* Header */}
      <header className="sticky top-0 z-40 border-b border-border/50 bg-white/95 backdrop-blur-sm shadow-sm">
