...
async function main() {
  ...
  const subjectId = 62; // PUHH-Arang
  const competencyUnitId = 474; // A.02GNS01.068.1
  ...
  const questionsData = [
    // --- PILIHAN GANDA (10 Soal) ---
    {
      ...
      correct_answer: "C",
      difficulty: "EASY",
      explanation: "Pengangkutan produk arang kayu dari tempat pengolahan dilengkapi dengan dokumen Nota Angkutan.",
      status: "ACTIVE"
    },
    {
      subject_id: subjectId,
      ...
      correct_answer: "B",
      difficulty: "EASY",
      explanation: "Pengangkutan kayu bulat kecil asal hutan hak/kebun masyarakat menuju tempat pengolahan arang menggunakan Surat Angkutan Kayu Rakyat (SAKR).",
      status: "ACTIVE"
    },
    {
      subject_id: subjectId,
    ...
    },
    {
      ...
      correct_answer: "B",
      difficulty: "MEDIUM",
      explanation: "Jika SKSHHK habis masa berlakunya akibat kerusakan alat angkut dalam perjalanan, pengemudi/nakhoda wajib membuat Surat Keterangan bermaterai cukup.",
      status: "ACTIVE"
    },
    {
      subject_id: subjectId,
    ...
    },
    {
      ...
      correct_answer: "A",
      difficulty: "EASY",
      explanation: "Penggunaan sendiri kayu olahan dalam 1 lokasi terpadu dicatat di SIPUHH melalui laporan DKDS.",
      status: "ACTIVE"
    },
    {
      subject_id: subjectId,
      ...
      correct_answer: "A",
      difficulty: "MEDIUM",
      explanation: "Hasil pengolahan kayu dari bahan baku hutan hak diangkut menggunakan dokumen Nota Perusahaan.",
      status: "ACTIVE"
    },
    {
      subject_id: subjectId,
      ...
      correct_answer: "C",
      difficulty: "EASY",
      explanation: "Dokumen angkutan kayu hanya berlaku untuk 1 kali pengangkutan ke 1 lokasi tujuan.",
      status: "ACTIVE"
    },
    ...
    // --- BENAR / SALAH (10 Soal) ---
    {
      ...
      correct_answer: "A",
      difficulty: "MEDIUM",
      explanation: "Pernyataan BENAR. Pengangkutan gabungan produk olahan kayu dan arang dengan dokumen sah masing-masing ke 1 lokasi tujuan yang sama diperbolehkan.",
      status: "ACTIVE"
    },
    {
      subject_id: subjectId,
      ...
      correct_answer: "B",
      difficulty: "EASY",
      explanation: "Pernyataan SALAH. Pengangkutan arang kayu secara bertahap dari tempat pengolahan ke pelabuhan muat menggunakan dokumen Nota Angkutan.",
      status: "ACTIVE"
    },
    {
      subject_id: subjectId,
  ...
  console.log("✅ Successfully inserted all 20 questions for PUHH-Arang and updated competency unit question_count!");
  await sql.end();
}
